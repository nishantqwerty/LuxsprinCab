    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="row mb-2">
                    <div class="col-sm-12">
                        <a class="btn btn-success" href="{{ route('add-message') }}" role="button"
                    ...
                    <table class="table table-striped table-hover table-reflow">
                        ...
                        <tbody>
                            @foreach ($reasons as $reason)
                                <tr>
                                    <td>
                                        @if ($reason->user_role == USER)
                                            User
                                        @elseif($reason->user_role == DRIVER)
                                            Driver
                                        @endif
                                    </td>
                                    <td> {{ $reason->reasons }} </td>
                                    <td>
                                        <a href="{{ route('edit-message', ['id' => $reason->id]) }}"> <i
                                                class="fa fa-edit"></i> <a>
                                                <a href="{{ route('delete-message', ['id' => $reason->id]) }}"> <i
